...
class ExperienceModel extends ChangeNotifier {
  List<Experience> erperiences = [
    ...
    Experience(
        ...
        title: "Ecom",
        desc:
            "Ecom is a shopping App. This app showcases a user interface (UI) design concept for a e-commerce mobile application.",
        photo: "assets/ecom.jpg"),
    Experience(
        stacks: ['Flutter', "Firebase"],
        tools: ["Figma", "Visual Studio Code"],
        id: "3",
    ...
    Experience(
        ...
        title: "APS Stock",
        desc:
            "APS Stock is using for both version Android and IOS. It can easily find spare parts of backhoes, trucks, excavators, and bulldozers. It can provide high quality products & excellent services at competitive prices.",
